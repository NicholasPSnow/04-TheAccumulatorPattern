...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(47)
    answer_from_my_code = factorial(47)
    ...
    print('Test 2 expected (by hand):', answer_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(3, 3, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(3, 9, .3)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.83333  # This is APPROXIMATELY the correct answer.
